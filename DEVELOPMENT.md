...
```bash
git remote add encore encore://hospitality-management-platform-cr8i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/hospitality-management-platform-cr8i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/hospitality-management-platform-cr8i/settings/integrations/github)
