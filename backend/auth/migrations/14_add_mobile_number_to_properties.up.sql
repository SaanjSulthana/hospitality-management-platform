-- Add mobile_number column to properties table and make address_json NOT NULL
...
-- Step 4: After migration, mobile_number should be made NOT NULL after data migration
-- This is commented out for now - uncomment after ensuring all existing properties have mobile numbers
