...
import { SkeletonChart, SkeletonStats } from '@/components/ui/loading-spinner';
...
export default function AnalyticsPage() {
  ...
  // Progressive loading: Show header immediately
  ...
  // Removed blocking loading state - now handled inline with skeletons
    ...
    <div className="w-full min-h-screen bg-gray-50">
      <div className="px-6 pb-6 sm:py-6">
        <div className="space-y-6">
          ...
          {isInitialLoading ? (
            <>
              {/* Skeleton for Key Performance Indicators */}
            ...
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                ...
                <Card className="border-l-4 border-l-orange-500 shadow-sm hover:shadow-md transition-shadow duration-200">
                  ...
                  <CardContent>
                    <div className={`text-2xl font-bold ${(analytics.metrics?.netIncome || 0) >= 0 ? 'text-green-600' : 'text-red-600'
                      }`}>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                ...
                <Card className="border-l-4 border-l-blue-500 shadow-sm hover:shadow-md transition-shadow duration-200">
                  ...
                  <CardContent className="space-y-4">
                    <div
                      className={`text-3xl font-bold ${(analytics.metrics?.netIncome || 0) >= 0 ? 'text-green-600' : 'text-red-600'
                        }`}
                    >
                      {formatCurrency(analytics.metrics?.netIncome || 0)}
                    </div>
